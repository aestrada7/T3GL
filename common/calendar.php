...
function createTitle(which, string, x, y)
{
	...
	excessHeight = 20;
	element.innerHTML = '<div class="calendarPopup"><table cellspacing="0" cellpadding="0" border="0"><tr><td><table width="100%"><tr><td class="calendarPopup"><span>' + string + '</span></td></tr></table></td></tr></table></div>';
...
class Calendar
{
    ...
    */
    ...
    function getMatches($day, $month, $year)
    {
         $s = $this->cb->checkDate($day, $month, $year);
         $s = "<div align='left'>$s</div>";
         return $s;
    }
    ...
    */
    function getMonthHTML($m, $y, $showYear = 1)
    {
    	...
    	$s .= "<table width=100% height=100% border=1 class='calendar'>\n";
    	$s .= "<tr>\n";
    	...
    	while ($d <= $daysInMonth)
    	{
    	    ...
    	    for ($i = 0; $i < 7; $i++)
    	    {
    	        ...
    	        {
    	            $s .= $d;
    	            $s.= $this->getMatches($d, $month, $year);
    	        }
    	        else
    	        {
    	            $s .= "&nbsp;";
