...
<script language="JavaScript">document.title="<?echo($utils->LeagueTitle);?>" + " :: Logged Out";</script>
<? session_destroy(); ?>
    <table align="center" cellspacing="0" cellpadding="0" border="0" width="821px">
      <tr valign="top">
        ...
        <td class="Content">
	  <p class="Title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Logged Out</p>
          <p class="og" align="center">You were succesfully logged out.<br>
